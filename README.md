...
This is the firmware that powers Romo.
*Romo Firmware* is part of the [Romo SDK](https://github.com/Navideck/Romo).

Romo SDK gives you the power to write your own software for Romo robots. Firmware hacks and modifications are highly encouraged.
