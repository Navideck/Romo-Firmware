...
#define EEPROM_SERIALNUMBER_ADDRESS_ALT1	    (void*)0x0100          // 20 bytes including null terminator
#define EEPROM_SERIALNUMBER_ADDRESS_ALT2	    (void*)0x03EB          // 20 bytes including null terminator
