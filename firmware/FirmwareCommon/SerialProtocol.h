...
/************************************************************************/
/* Commands to the robot Firmware >= 1.2.0                              */
/************************************************************************/
typedef enum {
    RMCommandToRobotNull = 0x00,
...
//    RM_SER_CMD_SET_MOTOR_REAR_RIGHT = 0x28,
    ...
    RMCommandToRobotCheckResistor = 0x59,
    
    RMCommandToRobotReadInfo = 0x60, // <InfoType> <type dependent arguments>
    RMCommandToRobotReadParameter = 0x61, // <ParameterType> <parameter dependent arguments>
    RMCommandToRobotSetParameter = 0x62, // <ParameterType> <parameter dependent arguments>
